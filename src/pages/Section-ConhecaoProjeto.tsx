...
export function ConhecaOProjeto(){
    ...
    return(
        <div className="w-full bg-branco-fundoCards p-8 md:p-16 mx-auto">
            ...
            <div className="w-full md:w-4/5 flex flex-col-reverse md:flex-row items-center justify-between mx-auto gap-12">
                ...
                <div className='w-full flex flex-col gap-[46px]'>
                    ...
                    <Button onClick={Vaquinha} className='w-full md:w-1/3' variant="destructive">Seja um apoiador</Button>
                </div>
