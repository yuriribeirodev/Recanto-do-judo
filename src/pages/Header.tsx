...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="max-w-350 mx-auto flex items-center justify-between w-4/5">
        ...
        <div className="hidden md:flex">
          <a
            ...
            className="bg-vermelho-botao hover:bg-[#6a0c13] text-white font-semibold text-lg py-2 px-5 rounded-lg transition-all shadow-md hover:scale-105"
          >
            Contate-nos
          </a>
        </div>
